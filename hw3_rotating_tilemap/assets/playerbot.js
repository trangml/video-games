class PlayerBot {
    ...
    shoot() {
        ...
        if (keyArray[32]) {
            if (this.currFrameCount < (frameCount - 30)) {
                ...
                this.bullets[this.bulletsIndex].x = this.x;
                this.bullets[this.bulletsIndex].y = this.y;
                this.bullets[this.bulletsIndex].angle = this.angle - PI / 2;
                this.bulletsIndex++;
    ...
    move() {
        var movement_speed = 3.4;
        if (keyArray[LEFT_ARROW]) {
            //this.x -= movement_speed;
            this.angle = (this.angle - PI / 64) % (2 * PI);
        }
        ...
        if (keyArray[UP_ARROW]) {
            ...
            this.y_delta = movement_speed * sin(this.angle - PI / 2);
            this.x_delta = movement_speed * cos(this.angle - PI / 2);
        }
