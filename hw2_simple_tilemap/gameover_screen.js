...
class GameOverScreenObj {
    constructor(backsplash) {
        ...
        this.x = 0;
        this.y = 0;
        this.player = new PlayerBot(-30, -30, 60);
        this.dead_player = new PlayerBot(-15, -15, 30, "white", "gray", "gray");
        this.enemy = new EnemyBot(-30, -30, 60);
    ...
    loss() {
        ...
        textSize(12);
        var inst_strs = [
            "You were chomped by a Devi-Bot!",
        ...
        pop();
        push();
        translate(width / 2 + 40, 270 + this.y_hop / 2.5);
