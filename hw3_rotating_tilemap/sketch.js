/**
 * ECE_4525: Project 3, Wide Tilemap with Rotation
 ...
 * The robot can shoot nuts using space bar to kill the enemies.
 */
...
function restartGame() {
  score = 0;
  player = new PlayerBot(1150, 50, 17);
